...
{
    public class OrdenDeServicioModel
    {
        internal string connectionString { get; private set; }
        private readonly IConfiguration _configuration;


        public OrdenDeServicioModel(IConfiguration configuration)
        {
            _configuration = configuration;
        }

        public OrdenDeServicioModel() : base()
        {
        ...
        public List<Vehiculos> ObtenerPDF(int clienteId)
        {
            string query = $"exec [Clientes].[ordendeservicio]  {clienteId}";
